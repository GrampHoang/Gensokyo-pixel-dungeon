...
public class YukariGapSprite extends MobSprite {
	...
	public YukariGapSprite() {
		...
		texture( Assets.Sprites.YUKARIGAP );
		
		TextureFilm frames = new TextureFilm( texture, 7, 14 );
		...
		attack.frames( frames, 0, 1, 2, 3, 4, 5, 6 );
