...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.touhou.KanakoBoss;
...
public class MountainBossLevel extends Level {
	...
	public void seal() {
		...
		KanakoBoss boss = new KanakoBoss();
