...
public class FeedbackScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton link = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "supporter_link")){
			...
			protected void onClick() {
				super.onClick();
				String link = "https://forms.gle/5KX2NYASvqUQaLrb8";
	...
	private static class SupporterMessage extends Component {
		...
		protected void createChildren() {
			...
			String message = "Hey, if you enjoy the game, or have some problems, found bugs, etc then you can give me some feedback through the link below.\nYou can write it as detail as you want, as long as you want. Any idea are welcome too, though don't be too unrealistic or throw the game balance away xD";
