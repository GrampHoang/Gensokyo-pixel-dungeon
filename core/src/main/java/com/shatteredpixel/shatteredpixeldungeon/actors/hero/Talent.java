...
public enum Talent {
	...
	// Koishi T1
	FAST_FOOD(256), LEARNING(257), OPEN_WOUND(258), SURPRISE_SHIELD(259),
	// Koishi T2
	MIND_FOOD(260), FEARFUL_UPGRADE(261), SURPRISE_MOMENTUM(262), SURPRISE_PUSH(263), BAD_GIRL(264),
	// Koishi T3
	NIGHTMARE(265, 3), DIRECT_SURPRISE(266, 3),
	// Imaginary T3
	IMAGINARY_FRIEND(267, 3), HIDDEN_DANGER(268, 3), FREE_SPIRIT(269, 3),
	// Satori T3
	CORRUPTION(270, 3), MIND_BREAK(271, 3), MIND_READ(272, 3),
	// Full Moon (shoot circle)
	//Mind Stopper (sentries)
	//Lunatic Red eye (amok)
	...
	public static void onTalentUpgraded( Hero hero, Talent talent ){
		...
		if (talent == WEAPON_INTUITION && hero.pointsInTalent(WEAPON_INTUITION) == 2){
			for (EquipableItem item : Dungeon.hero.belongings.getAllItems( EquipableItem.class )){
