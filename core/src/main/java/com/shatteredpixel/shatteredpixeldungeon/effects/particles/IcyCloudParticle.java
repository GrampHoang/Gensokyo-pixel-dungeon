...
public class IcyCloudParticle extends PixelParticle {
	
	public static final Factory FACTORY = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((IcyCloudParticle)emitter.recycle( IcyCloudParticle.class )).reset( x, y );
		}
	};
	...
	public static final Factory SPEW = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((IcyCloudParticle)emitter.recycle( IcyCloudParticle.class )).resetSpew( x, y );
		}
	};
	
	public IcyCloudParticle() {
		super();
		color( 0x54A9DF );
		//color( 0x86DBFF);
		acc.set( 0, -40 );
